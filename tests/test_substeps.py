...
class TestSubsteps(unittest.TestCase):
    ...
    def test_fraction_addition_partial(self):
        ...
        # self.assertIn("1/2+1/3=5/6", joined) - this is done in scratchpad() now
    ...
    def test_fraction_subtraction_partial(self):
        ...
        # self.assertIn("3/4-1/6=7/12", joined) - this is done in scratchpad() now
    ...
    def test_fraction_multiplication_partial(self):
        ...
        self.assertIsInstance(steps, list)
        joined = ", ".join(steps)
        # Should show simplification to 1/3
    ...
    def test_fraction_division_partial(self):
        ...
        # self.assertIn("1*3=3", joined) - no longer generated
        # self.assertIn("2*1=2", joined) - no longer generated
